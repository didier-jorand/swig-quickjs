...
var intPair = li_std_pair.makeIntPair(7, 6);
...
var intPairConstRef = li_std_pair.makeIntPairConstRef(7, 6);
...
var intPairPtr = li_std_pair.makeIntPairPtr(7, 6);
check(typeof intPairPtr === 'object');
check(intPairPtr.first === 7);
check(intPairPtr.second === 6);

var intPairRef = li_std_pair.makeIntPairRef(7, 6);
